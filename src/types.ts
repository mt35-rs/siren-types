...
export type Siren<P extends Properties | undefined = undefined> = Entity<P>;
 ...
 */
export type SubEntity<P extends Properties | undefined = undefined> =
 ...
 */
export interface EmbeddedRepresentationSubEntityWithProperties<P>
  extends EntityWithProperties<P> {
  // rel - Defines the relationship of the sub-entity to its parent, per Web Linking (RFC5899).
  // required and cannot be empty.
  rel: string[];
}

export interface EmbeddedRepresentationSubEntityWithoutProperties
  extends EntityWithoutProperties {
  // rel - Defines the relationship of the sub-entity to its parent, per Web Linking (RFC5899).
  // required and cannot be empty.
  rel: string[];
}

export type EmbeddedRepresentationSubEntity<
  P extends Properties | undefined = undefined
> = P extends undefined
  ? EmbeddedRepresentationSubEntityWithoutProperties
  : EmbeddedRepresentationSubEntityWithProperties<P>;
